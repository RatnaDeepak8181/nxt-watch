...
export const SideBarAndGamingContainer = styled.div`
  ...
  min-height: 100vh;
`
export const LogoContainerAndGamingVideosContainer = styled.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`
export const GamingVideoCardUl = styled.ul`
  padding: 10px;
...
export const GamingContainer = styled.div`
  ...
  width: 100%;
`
export const GamingContainerForLogo = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
...
export const GamingLogo = styled(SiYoutubegaming)`
  ...
  color: #ff0000;
`
export const GamingContainerHeading = styled.h1`
